...
public class Message {
    ...
    public static final String HORSE_RACING_WELCOME_MESSAGE =
            "─────────────────────────────── 게임 설명 ───────────────────────────────\n" +
                    "▓ 1 ~ 10번 중에서 한 마리의 말을 선택하세요.\n" +
                    "▓ 선택하면, 5초 후 10마리의 말이 레이스를 시작합니다.\n" +
                    "▓ 앞서는 말의 한 칸 뒤까지 접근한다면 서로 자리가 스위칭됩니다.\n" +
    ...
    public static final String HORSE_RACING_CONDITION_MESSAGE = "원하는 말의 번호를 입력해주세요: ";
